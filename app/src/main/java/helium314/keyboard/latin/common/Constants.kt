...
object Links {
    ...
    const val GITHUB = "https://github.com/HansHolz09/BlurBoard"
    const val ORIGIN_GITHUB = "https://github.com/Helium314/HeliBoard"
    const val LICENSE = "$GITHUB/blob/main/LICENSE"
    const val LAYOUT_WIKI_URL = "$ORIGIN_GITHUB/wiki/2.-Layouts"
